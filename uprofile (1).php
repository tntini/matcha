...
<div class="banner-home">
    ...
    <div class="middle-container">
        <h1 class="class">Profile of <?php echo $userinfo->name ." - " .$userinfo->age; ?>
            <span><i class="fa fa-star" aria-hidden="true"></i><?php echo $userinfo->popscore; ?></span>
        </h1>
        <div class="infos-container">
            <?php if ($userinfo->gender === "M") { ?>
                <h4><span class="class">Gender :</span> <span ><?php echo $userinfo->gender; ?></span></h4>
            <?php }else{ ?>
                <h4><span class="class">Gender :</span> <span><?php echo $userinfo->gender; ?></span></h4>
            <?php } ?>
            <br>
            <?php if ($userinfo->orientation === "F") { ?>
                <h4><span class="class">Interested by :</span> <span><?php echo $userinfo->orientation; ?></span></h4>
            <?php }else{ ?>
                <h4><span class="class">Interested by :</span> <span><?php echo $userinfo->orientation; ?></span></h4>
            <?php } ?>
            <br>
